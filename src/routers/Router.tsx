...
import SubchatPage from "../pages/SubchatPage/SubchatPage";
import NewSubchatPage from "../pages/SubchatPage/NewSubchatPage";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/subchat/post" element={<NewSubchatPage />}></Route>
